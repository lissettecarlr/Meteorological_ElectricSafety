...
//是否在userInterrupt.cpp中编写中断函数，屏蔽则是不需要
#define USE_USER_IRQ_TIMER1
//#define USE_USER_IRQ_TIMER2
//#define USE_USER_IRQ_TIMER3
#define USE_USER_IRQ_TIMER4

//
#define USE_USER_UPDATE_TIMER2
#define USE_USER_UPDATE_TIMER3
//~~~~~~~~~~~~~~Capture Congfigure~~~~~~~~~~//
